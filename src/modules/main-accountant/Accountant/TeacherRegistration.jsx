...
const empty = {
  ...
  mobile: "", email: "", aadhaar: "", pan: "", currentAddress: "", permanentAddress: "",
  subject: "", classGrade: "", experience: "", prevSchool: "", designation: "", duration: "",
  salaryExpect: "", availableToJoin: "", profile: "",
    ...
    return (
      ...
      >
        ...
        <div className="row-flex">
          ...
          <div className="col-flex"><TextField label="Email ID" required type="email" value={f.email} onChange={set("email")} placeholder="you@example.com" /></div>
        </div>
  ...
  if (step === 2) {
    return (
      ...
      >
        ...
        <div className="row-flex">
          <div className="col-flex"><TextField label="Designation at Current Institution" value={f.designation} onChange={set("designation")} placeholder="e.g. Assistant Teacher" /></div>
          <div className="col-flex"><TextField label="Duration at Current Institution" value={f.duration} onChange={set("duration")} placeholder="e.g. 2 years" /></div>
        </div>

        <h3 className="section-title">Salary &amp; Availability</h3><hr />
        <div className="row-flex">
          <div className="col-flex"><TextField label="Expected Monthly Salary (₹)" required value={f.salaryExpect} onChange={set("salaryExpect")} placeholder="e.g. 30000" /></div>
