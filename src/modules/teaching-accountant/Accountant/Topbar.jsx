  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
          ...
          <div className={`notif-dropdown ${notifOpen ? "show" : ""}`}>
            ...
            <div className="notif-item-dd">
              ...
              <div className="notif-txt flex-grow-1">
                <p>New teaching staff registration pending</p>
                <span>2 min ago</span>
              </div>
            </div>
            <div className="notif-item-dd">
        ...
        <div className="user-pill" title="Teaching Accountant">
          <div className="user-avatar">AD</div>
          <div className="d-none d-md-block">
            <div className="user-name">Accountant</div>
            <div className="user-role">Teaching Accountant</div>
          </div>
        </div>

        <NavLink to="/teaching-accountant" className="icon-btn" title="Logout">
