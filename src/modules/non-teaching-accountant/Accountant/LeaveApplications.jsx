...
// Leave applications submitted by Non-Teaching staff only — kept separate
...
export default function LeaveApplications() {
  ...
  return (
    <div>
      <PageHeader title="Leave Applications" subtitle="Leave requests submitted by Non-Teaching staff" />
