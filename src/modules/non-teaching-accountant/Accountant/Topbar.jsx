  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
          ...
          <div className={`notif-dropdown ${notifOpen ? "show" : ""}`}>
            ...
            <div className="notif-item-dd">
              ...
              <div className="notif-txt flex-grow-1">
                <p>New non-teaching staff registration pending</p>
                <span>2 min ago</span>
              </div>
            </div>
            <div className="notif-item-dd">
        ...
        <div className="user-pill" title="Non-Teaching Accountant">
          <div className="user-avatar">AD</div>
          <div className="d-none d-md-block">
            <div className="user-name">Accountant</div>
            <div className="user-role">Non-Teaching Accountant</div>
          </div>
        </div>

        <NavLink to="/non-teaching-accountant" className="icon-btn" title="Logout">
