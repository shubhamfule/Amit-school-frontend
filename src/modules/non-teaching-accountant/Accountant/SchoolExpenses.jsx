...
export default function SchoolExpenses() {
  ...
  return (
    <div>
      <PageHeader title="Non-Teaching Expenses Management" subtitle="Amit Group of Schools | Non-teaching staff operating expenses" />
      ...
      <div className="toolbar-row">
        ...
        <ExportButtons title="Non-Teaching Expenses" columns={exportColumns} rows={exportRows} filename="non-teaching-expenses" />
      </div>
