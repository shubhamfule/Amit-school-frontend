...
const empty = {
  fullName: "", father: "", mother: "", dob: "", gender: "", caste: "", category: "",religion: "", nationality: "", marital: "", email: "",
  mobile: "", emergency: "", aadhaar: "", pan: "", currentAddress: "", permanentAddress: "",
  empType: "", department: "", workExp: "", shift: "", prevOrg: "", monthlysalary: "", joiningdate: "", profile: "",
    ...
    return (
      ...
      >
        ...
        <div className="row-flex">
          ...
          <div className="col-flex"><SelectField label="Shift" required value={f.shift} onChange={set("shift")} options={["Morning Shift", "Afternoon Shift"]} /></div>
        </div>
        ...
        <div className="row-flex">
          <div className="col-flex"><TextField label=" Monthly Salary (₹)" required value={f.monthlysalary} onChange={set("monthlysalary")} placeholder="e.g. 16000" /></div>
          <div className="col-flex"><TextField label="Joning data" type="date" required value={f.joiningdate} onChange={set("joiningdate")} /></div>
        </div>
